...
public class Post implements Serializable {
    ...
    public Post(Integer id, String title, String postUrl, String userName, int voteCount, Integer userId, @NonNull Date postedAt, Date updatedAt, List<Comment> comments) {
        this.id = id;
        this.title = title;
